...
Start-Process powershell -ArgumentList "-NoExit", "-Command", "cd mfe-dashboard; npm run build; npm run preview"
Start-Process powershell -ArgumentList "-NoExit", "-Command", "cd mfe-details; npm run build; npm run preview"
Start-Process powershell -ArgumentList "-NoExit", "-Command", "cd mfe-shell; npm run build; npm run preview"

...
const OnHoldListHeader = ({
  ...
  const filtersWithCounts = [
    { ...PATCH_FILTERS[0], label: `${green}` },
    { ...PATCH_FILTERS[1], label: `${yellow}` },
    { ...PATCH_FILTERS[2], label: `${red}` },
  ];

...
const ListHeader = ({
  ...
  const STAGE_FILTERS = [
    { label: "VALIDATION IN-PROGRESS", value: "validation initiated,validation inprogress,validation failed" },
  ...
  const STATUS_KEY_MAP = {
    ...
    rejected: "REJECTED",
    "On Hold": "ON HOLD",
    "validation initiated,validation inprogress,validation failed": "VALIDATION_IN_PROGRESS",

...
const CorrectionsTable = ({ tableRows, invalidFields, execID }) => {
    ...
    const handleAccept = async (row) => {
        ...
        try {
            const res = await fetch("http://10.222.237.123:8001/approve-suggestion", {
                method: "PUT",
            ...
            if (!res.ok) throw new Error("Failed to submit accepted value");

            // Clear row state on success
